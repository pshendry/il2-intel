...
export default {
  ...
  procedures: {
    startup: ['Throttle: 1”', 'RPM: Full forward', 'Outlet Shutters: As required', 'Press E to start'],
    takeoff: [
    ...
    landing: [
      {
        text: 'Downwind',
        steps: ['Airspeed: Below 260 km/h', 'Outlet Shutters: As required', 'Flaps: Takeoff Position'],
      },
      {
        text: 'End Downwind',
        steps: ['Airspeed: Below 220 km/h', 'Landing Gear: Extend'],
      },
      {
        text: 'Base to Final',
        steps: ['RPM: Maximum', 'Flaps: Landing Position', 'Airspeed: 210 km/h'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=pl3EXXzIMSw&t=1m2s',
    startup: 'https://www.youtube.com/watch?v=pl3EXXzIMSw&t=3m42s',
