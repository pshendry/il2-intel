...
export default {
  ...
  procedures: {
    startup: ['Mixture: Rich', 'Throttle: 1”', 'Prop Pitch: Auto', 'Press E to start'],
    takeoff: [
      'Canopy: Closed',
      'Boost: ON',
      'Mixture: Rich',
      ...
      'Climb 210 km/h',
      'Boost: OFF',
      'Prop Pitch: Auto or Manual',
    ],
    landing: [
      {
        text: 'Downwind',
        steps: ['Prop Pitch: Auto or Manual', 'Airspeed: Below 280 km/h', 'Landing Gear: Extend'],
      },
      {
        text: 'End Downwind',
        steps: ['Airspeed: 220 km/h', 'Flaps: Start position'],
      },
      {
        text: 'Base to Final',
        steps: ['Flaps: Extend Fully', 'Airspeed: 190 km/h'],
      },
    ],
  },
  trainingVideos: {
