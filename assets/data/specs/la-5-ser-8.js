...
export default {
  ...
  procedures: {
    startup: [
      ...
      'Inlet/Outlet Cowl Shutters: As required',
      'Press E to start',
    ],
    takeoff: [
      'Canopy: Open',
      'Oil Radiator: As required',
      'Inlet/Outlet Cowl Shutters: Open',
      'Rotate: 190 km/h',
      'Climb: 260 km/h',
    ],
    landing: [
      {
        text: 'Downwind',
        steps: [
          'Airspeed: Below 320 km/h',
          'Gear: Extend',
          'RPM: Maximum',
          'Airspeed: Below 250 km/h',
          'Flaps: 20°',
          'Oil Radiator: As required',
          'Inlet/Outlet Shutters: As required',
        ],
      },
      {
        text: 'End Downwind',
  ...
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=TweBK_qsSNo&t=25s',
    startup: 'https://www.youtube.com/watch?v=TweBK_qsSNo&t=3m06s',
    takeoff: 'https://www.youtube.com/watch?v=TweBK_qsSNo&t=3m45s',
    landing: 'https://www.youtube.com/watch?v=TweBK_qsSNo&t=4m55s',
  },
};
