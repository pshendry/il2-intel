...
export default {
  ...
  procedures: {
    startup: [
      ...
      'Oil/Intercooler Flaps: As required',
      'Press E to start',
    ],
    takeoff: [
      'Tailwheel: Locked',
      'Canopy: Open',
      'Oil/Intercooler Flaps: As required',
      'Rudder Trim: Set to T/O',
      'Elevator Trim: NH with full aux tank',
      'Mixture: Auto Rich',
      'Turbo: Linked with throttle',
      'Propeller: Full forward',
      'Cowl Flaps: Open',
      '120 mph: Rotate',
      'Climb: 165 mph',
    ...
    landing: [
      {
        ...
        steps: [
          'Mixture: Auto Rich',
          'Propeller: Auto, 2550 RPM',
          'Turbo: Linked with throttle',
          'Cowl flaps: As required',
          'Airspeed: Below 200mph',
          'Landing Gear: Extend',
        ],
      },
      {
        text: 'End Downwind',
        steps: ['Airspeed: 150 mph', 'Flaps: Extend fully'],
      },
      {
        text: 'Base to Final',
        steps: ['Airspeed: 120 mph engine on (130 mph engine off)'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=ehIP9YLek1Q&t=8s',
    startup: null,
    takeoff: 'https://www.youtube.com/watch?v=ehIP9YLek1Q&t=7m33s',
    landing: 'https://www.youtube.com/watch?v=ehIP9YLek1Q&t=9m55s',
  },
};
