...
export default {
  ...
  procedures: {
    startup: ['Mixture: Auto Rich', 'RPM: Maximum', 'Water Radiator: As required', 'Throttle: 1”', 'Press E to start'],
    takeoff: [
      'Canopy: Open',
      'Rudder Trim: Full Starboard',
      'Elevator Trim: 1 div. below neutral',
      'Water Radiator: Full Open',
      'Mixture: Auto Rich',
      'RPM: Maximum',
      '100 mph: Rotate',
      'Climb: 160 mph',
    ...
    landing: [
      {
        ...
        steps: [
          'Canopy: Open',
          'Water Radiator: As required',
          'Mixture: Auto Rich',
          'Airspeed: Below 140mph',
          'Gear: Extend',
        ],
      },
      {
      ...
      {
        text: 'Base to Final',
        steps: ['Airspeed: 95 mph'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=Povrm28nExA&t=6s',
    startup: 'https://www.youtube.com/watch?v=Povrm28nExA&t=4m16s',
    takeoff: 'https://www.youtube.com/watch?v=Povrm28nExA&t=4m49s',
    landing: 'https://www.youtube.com/watch?v=Povrm28nExA&t=6m48s',
  },
};
