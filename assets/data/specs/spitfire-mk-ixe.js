...
export default {
  ...
  procedures: {
    startup: ['Throttle: 1”', 'RPM: Full forward', 'Press E to start'],
    takeoff: [
      'Canopy: Open',
    ...
    landing: [
      {
        text: 'Downwind',
        steps: ['RPM: 2650', 'Airspeed: Below 160 mph', 'Canopy: Open', 'Gear Extend'],
      },
      {
        text: 'End Downwind',
        steps: ['Flaps: Extend'],
      ...
      {
        text: 'Base to Final',
        steps: ['RPM: Maximum', 'Airspeed: 95 mph engine on (105 mph engine off)'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=OhYpyQgYy3M&t=8s',
    startup: null,
    takeoff: 'https://www.youtube.com/watch?v=OhYpyQgYy3M&t=4m01s',
    landing: 'https://www.youtube.com/watch?v=OhYpyQgYy3M&t=5m42s',
  },
};
