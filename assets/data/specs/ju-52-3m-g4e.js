...
export default {
  ...
  procedures: {
    startup: ['Mixtures: Full Rich', 'Water/Oil Radiators: As required', 'Throttle: 1”', 'Press E to start'],
    takeoff: [
      'H-Stab Trim: +2',
      'Flap Control: ON',
      'H-Stab Trim: Zero (Flaps 25°)',
      'Rudder Trim: Neutral',
      'Mixtures: Full Rich',
      'Cowl Flaps/Oil Radiators: Open',
      '110 km/h: Rotate',
      'Climb: 140 km/h',
    ],
    landing: [
      {
        text: 'Downwind',
        steps: [
          'Airspeed: Below 170 km/h',
          'H-Stab Trim: +2',
          'Flap Control: ON',
          'Mixtures: Full Rich',
          'Cowl Flaps/Oil Radiators: As required',
        ],
      },
      {
        text: 'End Downwind',
        steps: ['Airspeed: 150 km/h', 'Flaps: 25°'],
      },
      {
        text: 'Base to Final',
        steps: ['Flaps: 40°', 'Airspeed: 140 km/h'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=2Kkwxw1qFk8&t=6s',
    startup: 'https://www.youtube.com/watch?v=2Kkwxw1qFk8&t=4m41s',
    takeoff: 'https://www.youtube.com/watch?v=2Kkwxw1qFk8&t=8m46s',
    landing: 'https://www.youtube.com/watch?v=2Kkwxw1qFk8&t=11m26s',
  },
};
