...
export default {
  ...
  procedures: {
    startup: [
      'Propeller: Forward',
      'Mixture: Cutoff',
      'Oil/Intercooler: Auto',
      'Throttle: 1”',
      'Press E to start',
      'As engine starts: Mixture Auto Rich (70%)',
    ],
    takeoff: [
      'Propeller: Full forward',
      'Mixture: Auto Rich (70%)',
      'Flaps: Up (max 1/2 is allowed)',
      'Oil/Coolant Shutters: Auto',
      'Intercooler: Open',
      'Trims: All set to zero',
      'Brakes: Hold',
      'Throttle: 46” MP, wait a few secs',
      'Brakes: Release',
      'Throttle: 54” MP',
      '100 mph: Rotate',
      'Climb: 160 mph',
    ...
    landing: [
      {
        text: 'Downwind',
        steps: ['Mixture: Auto Rich', 'RPM: 2600', 'Airspeed: Below 175 mph', 'Landing Gear: Extend'],
      },
      {
        text: 'End Downwind',
        steps: ['Airspeed: 150 mph', 'Flaps: Extend to full'],
      },
      {
        text: 'Base to Final',
        steps: ['Flaps: Extend once landing assured', 'Airspeed: Slow to 120..130 mph'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=DMC0M6xV3xo&t=9s',
    startup: 'https://www.youtube.com/watch?v=DMC0M6xV3xo&t=4m33s',
