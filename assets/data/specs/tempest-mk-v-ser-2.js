...
export default {
  ...
  procedures: {
    startup: [
      'RPM: Full forward',
      'Supercharger: M ratio',
      'Radiator Shutter: Down',
      'Mixture: Start',
      'Throttle: 1”',
      'Press E to start',
    ],
    takeoff: [
      'Rudder Trim: Full to port',
      'Elevator Trim: 1 ½ div nose down',
      'Flaps: Up',
      'Supercharger: M ratio',
      'Radiator Shutter: Down',
    ...
    landing: [
      {
        text: 'Downwind',
        steps: ['Airspeed: Below 200 mph', 'Propeller: Full forward', 'Supercharger: M ratio', 'Gear: Extend'],
      },
      {
        text: 'End Downwind',
        steps: ['Airspeed: 150 mph', 'Flaps: 30°'],
      },
      {
        text: 'Base to Final',
        steps: ['Airspeed: 140 mph'],
      },
      {
        text: 'Final',
        steps: ['Flaps: Extend to full', 'Airspeed: 100 mph'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=5nsTW7ndL90&t=8s',
    startup: 'https://www.youtube.com/watch?v=5nsTW7ndL90&t=3m54s',
    takeoff: 'https://www.youtube.com/watch?v=5nsTW7ndL90&t=6m36s',
    landing: 'https://www.youtube.com/watch?v=5nsTW7ndL90&t=9m06s',
  },
};
