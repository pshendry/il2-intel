...
export default {
  ...
  procedures: {
    startup: [
      ...
      'Coolant Shutter: As required',
      'Press E to start',
    ],
    takeoff: [
      'Canopy: Closed',
      'Rudder Trim: 4 grads right',
      'Elevator Trim: 3-4 grads up',
      'Aileron Trim: Zero',
      'RPM: Full forward',
      'Mixture: Auto Rich',
      'Oil Cooler: Open',
      'Coolant Shutter: Open',
      '100 mph: Rotate',
      'Climb: 160 mph',
    ],
    landing: [
      ...
      {
        text: 'End Downwind',
        steps: ['Airspeed: Below 150 mph', 'Flaps: Extend fully'],
      },
      {
        text: 'Base to Final',
        steps: ['Airspeed: 110 mph'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=rHZKKalC4us&t=5s',
    startup: null,
    takeoff: 'https://www.youtube.com/watch?v=rHZKKalC4us&t=6m03s',
    landing: 'https://www.youtube.com/watch?v=rHZKKalC4us&t=8m15s',
  },
};
