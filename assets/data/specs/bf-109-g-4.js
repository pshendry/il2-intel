...
export default {
  ...
  airframe: {
    indicatedStallSpeedRanges: {
      takeoffLanding: [Q('154 km/h'), Q('167 km/h')],
      flight: [Q('165 km/h'), Q('175 km/h')],
    },
  ...
  load: {
    emptyWeight: Q('2506 kg'),
    minimumWeight: Q('2669 kg'),
    standardWeight: Q('3014 kg'),
    maxTakeoffWeight: Q('3303 kg'),
  ...
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=EO4hrws-yAs&t=9s',
    startup: null,
    takeoff: 'https://www.youtube.com/watch?v=EO4hrws-yAs&t=3m21s',
    landing: 'https://www.youtube.com/watch?v=EO4hrws-yAs&t=5m03s',
  },
};
