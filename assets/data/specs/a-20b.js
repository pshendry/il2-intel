...
export default {
  ...
  procedures: {
    startup: [
      ...
      'RPM: Full forward',
      'Throttle: 1”',
      'Upper cowl flaps: Open',
      'Lower cowl flaps: Open',
      'Press E to start',
    ],
    takeoff: [
      'Mixture: Auto',
      'RPM: Full forward',
      'Elevator Trim: ½ div forward',
      'Rudder/Aileron Trim: Neutral',
      'Upper cowl flaps: Closed',
      'Lower cowl flaps: Open',
      '100 mph: Rotate 1/3 flaps',
      '115 mph: Rotate no flaps',
      'Climb: 145 mph',
    ],
    landing: [
      {
        ...
        steps: [
          ...
          'MP/RPM: 15” / 2300',
          'RPM: Full forward',
          'Lower Cowl Flaps: As required',
          'Airspeed: Below 150 mph',
          'Water/Oil Radiators: As required',
        ],
      },
      {
        text: 'End Downwind',
        steps: ['Gear: Extend', 'Flaps: Extend to full'],
      },
      {
        text: 'Base to Final',
        steps: ['Airspeed: 120 mph'],
      },
    ],
  },
  trainingVideos: {
