...
export default {
  ...
  procedures: {
    startup: [
      'Press E to start',
      '1000RPM – Hold engine igniter',
      '2000RPM – Throttle to 3000 RPM',
      '3000RPM – Release engine igniter',
    ],
    takeoff: [
      'Canopy: Closed',
      'Flaps: 20°',
      'H-Stab Trim:',
      '0 to +1 (aux tanks empty)',
      '+2 to +3 (aux tanks full)',
      'Brakes: Hold',
      'Throttle: Increase to 7000RPM',
      'Brakes: Release',
      'Throttle: Full thrust',
      '200 km/h: Rotate',
      'Climb: 475..500 km/h',
    ],
    landing: [
      {
        text: 'Downwind',
        steps: ['Throttle: 6000 RPM', 'Airspeed: Below 350 km/h', 'Landing Gear: Extend', 'H-Stab Trim – Nose up'],
      },
      {
        text: 'End Downwind',
        steps: ['Airspeed: Below 300 km/h', 'Flaps: Extend fully'],
      },
      {
        text: 'Base to Final',
        steps: ['Airspeed: 250 km/h', 'At 100 ft – Slowly reduce to idle thrust'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=kUOomY9Xu9o&t=5s',
    startup: 'https://www.youtube.com/watch?v=kUOomY9Xu9o&t=3m10s',
