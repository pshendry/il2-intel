...
export default {
  ...
  procedures: {
    startup: [
      ...
      'Supercharger: Auto',
      'Oil/coolant Radiators: Auto',
      'Press E to start',
      'As engine starts: Mixture to RUN',
    ],
    takeoff: [
      'Canopy: Open',
      'Flaps: 20°',
      ...
      {
        text: 'Elevator Trim:',
        steps: ['Flaps down, 6° tail heavy', 'Flaps up, 3° nose heavy'],
      },
      'Mixture: Auto Rich/Run',
      'Propeller: Full forward',
      'Supercharger: Auto',
      'Oil/coolant Radiators: Auto ',
      '100 mph: Rotate',
    ...
    landing: [
      ...
      {
        text: 'End Downwind',
        steps: ['Airspeed: 150 mph', 'Flaps: 20°'],
      },
      {
        text: 'Base to Final',
        steps: ['Flaps: Extend fully', 'Airspeed: 130 mph'],
      },
    ],
  },
  trainingVideos: {
    cockpit: 'https://www.youtube.com/watch?v=d-WxvRRgj3o&t=5s',
    startup: 'https://www.youtube.com/watch?v=d-WxvRRgj3o&t=3m40s',
    takeoff: 'https://www.youtube.com/watch?v=d-WxvRRgj3o&t=5m45s',
    landing: 'https://www.youtube.com/watch?v=d-WxvRRgj3o&t=7m50s',
  },
};
