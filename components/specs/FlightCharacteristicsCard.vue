      ...
      <b-table-simple class="spec-table" small>
        <b-tbody>
          <b-tr>
            ...
            <b-td class="text-right">{{ speedRange(specs.airframe.indicatedStallSpeedRanges.takeoffLanding) }}</b-td>
          </b-tr>
          <b-tr>
            <b-td class="text-right">Flight</b-td>
            <b-td class="text-right">{{ speedRange(specs.airframe.indicatedStallSpeedRanges.flight) }}</b-td>
          </b-tr>
          <b-tr>
          ...
          <b-tr v-for="(maxTrue, i) in specs.characteristics.maxTrueAirspeeds" :key="i">
            <b-th v-if="i === 0" :rowspan="specs.characteristics.maxTrueAirspeeds.length">Max. true airspeed</b-th>
          ...
          <b-tr>
            ...
            <b-td class="text-right">{{ speed(specs.characteristics.maxPerformance.climb[0].speed) }}</b-td>
          </b-tr>
          <b-tr>
